...
$routes->get('/view', 'Hallo::index');
$routes->get('/lihat', 'Pages::index');
$routes->get('/tugas', 'Halaman::about');
$routes->get('/crud', 'Crud::index');

// insert
$routes->get('/Crud/tambah', 'Crud::tambah');
$routes->post('/Crud/insert', 'Crud::insert');

$routes->delete('/crud/hapus', 'Crud::hapus');
